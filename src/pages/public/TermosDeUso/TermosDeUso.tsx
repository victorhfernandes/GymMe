  ...
  return (
    <div>
      ...
      <p>
        ...
        Em questão dos usuários instrutores a idade mínima fica restrita à 18,
      ...
      <p>
        <strong>1.3.</strong> O usuário concorda em cumprir todas as leis
        aplicáveis, estes Termos quando usar os Serviços e que somente poderá
        usar os Serviços para finalidades legítimas.
      </p>
      <p>
        <strong>1.4.</strong> Aceitação dos termos e condições de uso. Ao se
        cadastrar e utilizar continuamente os serviços, todos os usuários de
        qualquer natureza estão declarando ter lido, entendido e aceito os
        termos. Caso, a qualquer tempo, o usuário instrutor não concorde com os
        termos, deverá cessar imediatamente a utilização do aplicativo e
        desinstalá-lo de seu aparelho.
      </p>

      <h2>2. DOS DADOS PESSOAIS DE TODOS OS USUÁRIOS</h2>
      <p>
        <strong>2.1.</strong> Todos e quaisquer usuários têm total
      ...
      <p>
        <strong>2.3.</strong> Ao concordar com os termos de uso e com os termos
        de uso, os usuários têm ciência que todas suas informações pessoais
        cadastradas serão lidas, analisadas, processadas e armazenadas desde o
        ato de cadastramento.
      </p>

      <h2>3. DAS RESPONSABILIDADES DE TODOS OS USUÁRIOS</h2>
      <p>
        <strong>3.1.</strong> O usuário é totalmente responsável pela veracidade
        das informações, sobretudo sobre as documentações oficiais cadastradas,
        como CPF e CREF, respondendo judicialmente caso a informação cadastrada
        não for verídica.
      </p>
      <p>
        <strong>3.2.</strong> O usuário se compromete, sob as penas da lei, a
        utilizar sua Conta do Aplicativo apenas de maneira e para fins
        estritamente legais, legítimos e permitidos por estes Termos de Uso.
      </p>
      <p>
        <strong>3.3.</strong> O usuário não poderá de nenhum modo transferir sua
        conta a nenhuma outra pessoa ou entidade.
      </p>
      <p>
        <strong>3.4.</strong> O usuário tem total responsabilidade por quaisquer
        mídias inseridas no site, respondendo legalmente pelo uso indevido
        destas em caso de direitos autorais violados, se houver imagens
        sensíveis.
      </p>
      <p>
        <strong>3.5.</strong> Fica sob total responsabilidade do usuário
      ...
      <p>
        <strong>4.7.</strong> Não é permitida a utilização do aplicativo por
        menores de idade que não tiverem a autorização e/ou supervisão do(s)
        responsável(is) legal(is).
      </p>
      <p>
        <strong>4.8.</strong> A utilização do aplicativo por menores de idade
      ...
      <p>
        ...
        deverá revisá-los antes de enviar quaisquer informações pessoais.
      </p>
      ...
      <p>
        <strong>5.3.</strong> O Serviço não deve ser utilizado para qualquer
        finalidade que não atendam a estes termos de uso ou escopo de serviços
        propostos pela plataforma.
      </p>
      <p>
        <strong>5.4.</strong> O instrutor encontrará presencialmente ou não o
        aluno, dependendo do que foi acordado na negociação de serviços dentro
        da plataforma.
      </p>
      ...
      <p>
        ...
        experiência de usuário na utilização das funcionalidades da aplicação.
      </p>

      <h2>7. DAS PROIBIÇÕES</h2>
      <p>
        <strong>7.1.</strong> Quaisquer os indivíduos que manifestar-se de forma
        pejorativa, discriminatória baseada em gênero, etnia, orientação sexual,
        gênero, religião ou idade, e/ou utilizar-se de termos vulgares, de baixo
        calão, para referir-se a outro usuário dentro da plataforma estará
        sujeito à banimento.
      </p>
      <p>
        <strong>7.2.</strong> Aqueles que utilizarem de imagens e/ou tópicos de
        temas sensíveis, que contenham violência, drogas ilícitas e/ou
        insinuação sexual estarão sujeitos à banimento.
      </p>
      <p>
        <strong>7.3.</strong> Caso detectado uma conta falsa na plataforma, esta
        será banida, com a possibilidade de responder judicialmente por
        falsidade ideológica.
      </p>
      <p>
        <strong>7.4.</strong> Caso constatado qualquer tipo de assédio dentro da
        plataforma ou constatado em numerosas denúncias ocasionará no banimento
        do usuário.
      </p>
      <p>
        <strong>7.5.</strong> É estritamente proibida a publicação de
